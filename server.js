...
app.post('/api/test-email', async (req, res) => {
  try {
    ...
    const gmailConfig = {
      user: 'comdonate9@gmail.com',
      pass: 'pguh tsvh dtpl lfbs'
    };
...
app.listen(PORT, () => {
  ...
  console.log(`📧 Gmail SMTP configured: comdonate9@gmail.com`);
  console.log(`🔐 Gmail SMTP Status: READY TO SEND EMAILS`);
  console.log(`🔑 App Password: pguh tsvh dtpl lfbs (configured)`);
